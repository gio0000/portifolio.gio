...
const Progress = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(ProgressPrimitive.Root, Object.assign({ ref: ref, className: cn("relative h-4 w-full overflow-hidden rounded-full bg-secondary", className) }, props),
