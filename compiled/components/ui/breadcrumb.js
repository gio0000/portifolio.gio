...
const BreadcrumbSeparator = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ role: "presentation", "aria-hidden": "true", className: cn("[&>svg]:size-3.5", className) }, props), children !== null && children !== void 0 ? children : React.createElement(ChevronRight, null)));
};
